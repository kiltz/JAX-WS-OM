 ...
 * generated in the de.kiltz.kontakt.ws.v1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Suche_QNAME = new QName("http://kiltz.de/kontakt/ws/v1/", "suche");
    private final static QName _Hole_QNAME = new QName("http://kiltz.de/kontakt/ws/v1/", "hole");
    private final static QName _HoleResponse_QNAME = new QName("http://kiltz.de/kontakt/ws/v1/", "holeResponse");
    private final static QName _Neu_QNAME = new QName("http://kiltz.de/kontakt/ws/v1/", "neu");
    private final static QName _NeuResponse_QNAME = new QName("http://kiltz.de/kontakt/ws/v1/", "neuResponse");
    private final static QName _SucheResponse_QNAME = new QName("http://kiltz.de/kontakt/ws/v1/", "sucheResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.kiltz.kontakt.ws.v1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://kiltz.de/kontakt/ws/v1/", name = "suche")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://kiltz.de/kontakt/ws/v1/", name = "hole")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://kiltz.de/kontakt/ws/v1/", name = "holeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://kiltz.de/kontakt/ws/v1/", name = "neu")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://kiltz.de/kontakt/ws/v1/", name = "neuResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://kiltz.de/kontakt/ws/v1/", name = "sucheResponse")
